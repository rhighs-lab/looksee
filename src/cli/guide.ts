...
export const fullGuide = (cmds: readonly CommandSpec[]): string =>
  [
    ...
    'Bodies are GitHub-flavored markdown: lists, tables, `code spans`,',
    'links and fenced blocks. A fence with a language (```ts) is syntax',
    'highlighted, so paste the snippet or diff instead of describing it.',
    'Write locations as path:line, e.g. src/cart.js:20. A ```suggestion',
    'fence on a new-side line comment becomes an applicable suggestion.',
    '',
